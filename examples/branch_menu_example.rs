...
use crate::desktop::git::{
    BranchMenu, BranchMenuProps, BranchOperationResult, BranchOperation,
    BranchInfo, GitRepository, use_git_state
};
...
fn checkout_branch(repo_path: &PathBuf, branch_name: &str) -> Result<(), Box<dyn std::error::Error>> {
    ...
    if output.status.success() {
        ...
        Err(format!("Git checkout failed: {}", 
