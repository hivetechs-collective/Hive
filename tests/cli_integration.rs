...
use hive_ai::cli::{args::Cli, should_launch_tui, check_tui_capabilities};
use hive_ai::core::config::{HiveConfig, get_hive_config_dir, create_default_config};
...
async fn test_config_directory() {
    ...
    assert!(config_dir.to_string_lossy().contains(".hive") || 
