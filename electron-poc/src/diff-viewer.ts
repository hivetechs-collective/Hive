...
export class DiffViewer {
    ...
    private viewMode: 'inline' | 'side-by-side' = 'inline';
    ...
    public async showDiff(filePath: string, diff: string) {
    ...
    public async showFileDiff(filePath: string, originalContent: string, modifiedContent: string) {
        this.filePath = filePath;
    ...
    private render(): void {
        ...
        (window as any).diffViewer = this;
    }
    
    private renderInline(lines: DiffLine[]): string {
    ...
    private renderSideBySide(lines: DiffLine[]): string {
    ...
    public setViewMode(mode: 'inline' | 'side-by-side') {
        this.viewMode = mode;
    ...
    public close() {
        ...
        if ((window as any).diffViewer === this) {
            (window as any).diffViewer = null;
        }
    }
...
(window as any).DiffViewer = DiffViewer;