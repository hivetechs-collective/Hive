...
export class SimpleConsensusEngine {
  ...
  private generatorPhrases: string[] = [
    "conjuring", "dreaming", "imagining", "inventing", "concocting", "brewing", "cooking", "whipping up"
  ];
  private refinerPhrases: string[] = [
    "sprucing up", "buffing", "shining", "primping", "prettifying", "dolling up", "jazzing up", "tarting up"
  ];
  private validatorPhrases: string[] = [
    "nitpicking", "scrutinizing", "inspecting", "eyeballing", "double-checking", "fact-checking", "proofing", "vetting"
  ];
  private curatorPhrases: string[] = [
    "putting finishing touches", "wrapping up", "tying ribbons", "adding sparkle", "making magic", "perfecting", "finalizing", "delivering"
  ];
