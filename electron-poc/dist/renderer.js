...
require("./index.css");
require("./neural-consciousness.css");
require("./analytics.css");
require("./git.css");
require("./file-explorer.css");
require("./status-bar.css");
...
const vscode_scm_view_1 = require("./vscode-scm-view");
...
window.cloneRepository = () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  <div class="title-bar">
    ...
    <div class="title-bar-center">
      <div class="title-logo">
        <img src="${Hive_Logo_small_jpg_1.default}" alt="HiveTechs Logo" style="width: 24px; height: 24px; object-fit: contain; border-radius: 4px;" />
      </div>
    ...
    <div class="consensus-chat-panel" id="consensus-chat">
      ...
      <div class="progress-section" id="progress-section">
        <div class="progress-header">
          ...
          <img src="${Hive_Logo_small_jpg_1.default}" alt="Hive" 
            ...
            if (panelType === 'explorer') {
                ...
                if (container) {
                    ...
                    if (!window.editorTabs) {
                        ...
                        if (editorArea) {
                            window.editorTabs = new editor_tabs_1.EditorTabs(editorArea);
                    ...
                    addFileBtn === null || addFileBtn === void 0 ? void 0 : addFileBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                        console.log('Add file clicked');
                        if (window.fileExplorer) {
                            // Create a simple input dialog
                            const fileName = yield showInputDialog('New File', 'Enter file name:', 'untitled.txt');
                            if (fileName && fileName.trim()) {
                                console.log('Creating new file:', fileName);
                                yield window.fileExplorer.createFile(fileName.trim());
                            }
                        }
                    }));
                    addFolderBtn === null || addFolderBtn === void 0 ? void 0 : addFolderBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                        console.log('Add folder clicked');
                        if (window.fileExplorer) {
                            // Create a simple input dialog
                            const folderName = yield showInputDialog('New Folder', 'Enter folder name:', 'New Folder');
                            if (folderName && folderName.trim()) {
                                console.log('Creating new folder:', folderName);
                                yield window.fileExplorer.createFolder(folderName.trim());
                            }
                        }
                    }));
                    ...
                    collapseBtn === null || collapseBtn === void 0 ? void 0 : collapseBtn.addEventListener('click', () => {
                        ...
                        if (currentOpenedFolder && window.gitAPI) {
                            ...
                            window.gitAPI.setFolder(currentOpenedFolder).then(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    window.gitUI = new vscode_scm_view_1.VSCodeSCMView(container);
...
let consensusWebSocket = null;
let neuralConsciousness = null;
let currentStreamContent = new Map();
...
let runConsensusViaREST;
function addChatMessage(message, isSystem = false, messageType = 'user') {
...
(_a = document.getElementById('settings-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
...
(_b = document.getElementById('memory-btn')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
    addLogEntry('Memory Service panel clicked', 'info');
    openMemoryDashboard();
});
// Button handlers (using IPC like before)
(_c = document.getElementById('test-connection-btn')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    if (isProcessing)
        return;
    isProcessing = true;
    ...
    try {
        const result = yield window.backendAPI.testConnection();
...
(_d = document.getElementById('run-consensus-btn')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    if (isProcessing) {
        addLogEntry('⚠️ Consensus already in progress', 'warning');
        return;
    }
    if (!(consensusWebSocket === null || consensusWebSocket === void 0 ? void 0 : consensusWebSocket.isConnected())) {
        addLogEntry('🔄 Connecting to consensus engine...', 'info');
        consensusWebSocket === null || consensusWebSocket === void 0 ? void 0 : consensusWebSocket.connect();
        setTimeout(() => {
            var _a;
            if (consensusWebSocket === null || consensusWebSocket === void 0 ? void 0 : consensusWebSocket.isConnected()) {
                (_a = document.getElementById('run-consensus-btn')) === null || _a === void 0 ? void 0 : _a.click();
            }
            else {
    ...
    window.consensusStartTime = Date.now();
    totalTokens = 0;
    totalCost = 0;
    ...
    const currentProfileName = (activeProfile === null || activeProfile === void 0 ? void 0 : activeProfile.name) || 'Balanced Performer';
...
(_e = document.getElementById('new-conversation-btn')) === null || _e === void 0 ? void 0 : _e.addEventListener('click', () => {
...
(_f = document.getElementById('send-chat')) === null || _f === void 0 ? void 0 : _f.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!consensusWebSocket || !consensusWebSocket.isConnected()) {
        ...
        setTimeout(() => {
            ...
            if (consensusWebSocket === null || consensusWebSocket === void 0 ? void 0 : consensusWebSocket.isConnected()) {
                ...
                // Retry the send
                (_a = document.getElementById('send-chat')) === null || _a === void 0 ? void 0 : _a.click();
            }
            else {
    ...
    if (ENABLE_NEURAL_CONSCIOUSNESS && neuralConsciousness) {
        try {
            ...
            setTimeout(() => {
                neuralConsciousness === null || neuralConsciousness === void 0 ? void 0 : neuralConsciousness.updatePhase('memory');
            }, 500);
            // Phase 2: Context Synthesis (2-4s)
            setTimeout(() => {
                neuralConsciousness === null || neuralConsciousness === void 0 ? void 0 : neuralConsciousness.updatePhase('synthesis');
            }, 2500);
            // Phase 3: Classification (4-6s)
            setTimeout(() => {
                neuralConsciousness === null || neuralConsciousness === void 0 ? void 0 : neuralConsciousness.updatePhase('classification');
            }, 4500);
...
runConsensusViaREST = (query) => __awaiter(void 0, void 0, void 0, function* () {
    isProcessing = true;
    conversationStartTime = performance.now();
    window.consensusStartTime = Date.now();
    totalTokens = 0;
    ...
    try {
        ...
        const result = yield window.backendAPI.runQuickConsensus({
            query: query,
            profile: (activeProfile === null || activeProfile === void 0 ? void 0 : activeProfile.name) || 'Free Also'
        });
...
(_g = document.getElementById('chat-input')) === null || _g === void 0 ? void 0 : _g.addEventListener('keypress', (e) => {
    var _a;
...
function updateStageProgress(stage, percentage) {
...
if (testWSBtn) {
    ...
    testWSBtn.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
...
setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (window.backendAPI) {
            const health = yield window.backendAPI.healthCheck();
            updateConnectionStatus(true);
...
function setupMenuEventListeners() {
    ...
    (_b = (_a = window.electronAPI) === null || _a === void 0 ? void 0 : _a.onMenuOpenFolder) === null || _b === void 0 ? void 0 : _b.call(_a, (folderPath) => {
    ...
    (_d = (_c = window.electronAPI) === null || _c === void 0 ? void 0 : _c.onMenuNewFile) === null || _d === void 0 ? void 0 : _d.call(_c, () => {
    ...
    (_f = (_e = window.electronAPI) === null || _e === void 0 ? void 0 : _e.onMenuSaveFile) === null || _f === void 0 ? void 0 : _f.call(_e, () => {
        ...
        if (currentOpenedFolder && window.gitAPI) {
            try {
                ...
                if (status && status.isRepo) {
                    ...
                    if (warningsElement)
                        warningsElement.style.display = 'flex';
                    if (errorsElement)
                    ...
                    if (branchElement)
                        branchElement.style.display = 'none';
                    if (warningsElement)
        ...
        try {
            ...
            if (settings.hiveKey) {
                ...
                if (result.hiveValid && result.licenseInfo) {
                    ...
                    // Invalid license
                    if (userElement)
                        userElement.textContent = 'Invalid license';
                    if (planElement)
...
settingsModal = new settings_modal_1.SettingsModal(() => __awaiter(void 0, void 0, void 0, function* () {
    // Callback when settings are saved
    updateStatusBar();
    yield loadActiveProfile(); // Reload profile from database
...
function updateConversationCount() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const usage = yield ((_a = window.electronAPI) === null || _a === void 0 ? void 0 : _a.getUsageCount());
            if (usage) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (settings.activeProfileId || settings.activeProfileName) {
                ...
                const matchingProfile = profiles.find((p) => p.id === settings.activeProfileId ||
...
setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield updateStatusBar();
    yield loadActiveProfile(); // Await to ensure profile is loaded before continuing
    // ALWAYS update conversation count from local database (overrides D1)
    yield updateConversationCount();
    ...
    if (conversationsElement) {
        ...
        if (width < 480) {
            ...
            if (usedMatch && remainingMatch) {
                ...
                conversationsElement.textContent = `${(usedMatch === null || usedMatch === void 0 ? void 0 : usedMatch[1]) || '0'}/∞`;
            }
        }
        else {
            conversationsElement.textContent = fullText;
...
function showAnalyticsPanel() {
    ...
    analytics_1.analyticsDashboard.mount(analyticsPanel);
...
function hideAnalyticsPanel() {
    if (analyticsPanel) {
        analytics_1.analyticsDashboard.unmount();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `;
            try {
                ...
                const claudeCodeStatus = yield electronAPI.detectCliTool('claude-code');
...
function createCliToolCard(toolInfo) {
...
function openMemoryDashboard() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const isRunning = yield window.electronAPI.isMemoryServiceRunning();
        if (!isRunning) {
            console.log('[Memory] Starting Memory Service...');
            const started = yield window.electronAPI.startMemoryService();
            if (!started) {
        ...
        if (container.innerHTML.trim() === '') {
            ...
            memoryDashboardInstance = new memory_dashboard_1.MemoryDashboard();
            const dashboardElement = yield memoryDashboardInstance.create();
            container.innerHTML = '';
...
const saveConsensusAnalytics = (totalTokens, totalCost) => __awaiter(void 0, void 0, void 0, function* () {
    var _h, _j;
    ...
    const chatContent = document.getElementById('chat-content');
    const userMessages = chatContent === null || chatContent === void 0 ? void 0 : chatContent.querySelectorAll('.user-message');
    const lastUserMessage = ((_h = userMessages === null || userMessages === void 0 ? void 0 : userMessages[userMessages.length - 1]) === null || _h === void 0 ? void 0 : _h.textContent) || 'Consensus query';
    // Get the assistant's response
    const assistantMessages = chatContent === null || chatContent === void 0 ? void 0 : chatContent.querySelectorAll('.assistant-message');
    const lastAssistantMessage = ((_j = assistantMessages === null || assistantMessages === void 0 ? void 0 : assistantMessages[assistantMessages.length - 1]) === null || _j === void 0 ? void 0 : _j.textContent) || '';
    ...
    try {
        ...
        if (electronAPI && electronAPI.saveConversation) {
            ...
            const saved = yield electronAPI.saveConversation({
                conversationId,
...
const trackStageCompletion = (stage, tokens, cost) => {
    const stageMetric = {
        stage,
...
setTimeout(() => {
    var _a;
    (_a = document.getElementById('analytics-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
    ...
    if (neuralContainer && ENABLE_NEURAL_CONSCIOUSNESS) {
        neuralConsciousness = new neural_consciousness_1.NeuralConsciousness();
    ...
    const createPanel = (id, title, content) => {
        var _a;
        ...
        if (typeof content !== 'string') {
            (_a = panel.querySelector('.panel-body')) === null || _a === void 0 ? void 0 : _a.appendChild(content);
        }
...
function handleOpenFolder(folderPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (window.gitAPI) {
                yield window.gitAPI.setFolder(folderPath);
            }
            ...
            if (window.gitAPI) {
                ...
                if (gitContainer) {
                    ...
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        window.gitUI = new vscode_scm_view_1.VSCodeSCMView(gitContainer);
                        window.scmView = window.gitUI;
                        ...
                        setTimeout(() => {
                            ...
                            if (window.gitGraph && window.gitGraph.refresh) {
                                console.log('[Menu] Refreshing Git graph...');
                                window.gitGraph.refresh();
                            }
                        }, 1500);
                    }), 500);
                }
            ...
            if (window.statusBar) {
                window.statusBar.setWorkspaceInfo({
                    folder: folderName,
                    path: folderPath
                });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!currentOpenedFolder) {
                ...
                yield handleOpenFolder(parentFolder);
            }
...
if (typeof window !== 'undefined' && window.electronAPI) {
    ...
    window.electronAPI.onMenuResetState(() => __awaiter(void 0, void 0, void 0, function* () {
        console.log('[Menu] Reset state requested before reload');
        // Clear Git folder state
        if (window.gitAPI) {
            yield window.gitAPI.setFolder('');
        }
    ...
    window.electronAPI.onMenuCloseFolder(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (explorerContainer) {
            explorerContainer.innerHTML = '';
            window.fileExplorer = new vscode_explorer_exact_1.VSCodeExplorerExact(explorerContainer);
            yield window.fileExplorer.initialize(); // Initialize without a folder - shows welcome
        }
        ...
        if (window.editorTabs) {
            yield window.editorTabs.closeAllTabs();
        }
...
window.cloneRepository = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const repoUrl = yield window.electronAPI.showInputDialog('Clone Repository', 'Enter repository URL:');
        if (repoUrl) {
