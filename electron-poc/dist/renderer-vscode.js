...
(_a = document.getElementById('test-connection-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    if (isProcessing)
        return;
    isProcessing = true;
...
(_b = document.getElementById('run-consensus-btn')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    if (isProcessing)
        return;
    isProcessing = true;
    ...
    try {
        const result = yield window.backendAPI.runConsensus("What is the capital of France?");
        setTimeout(() => {
...
//# sourceMappingURL=renderer-vscode.js.map