...
exports.NeuralConsciousness = void 0;
...
class NeuralConsciousness {
    constructor() {
        ...
        this.canvas = this.container.querySelector('.neural-canvas');
    ...
    createContainer() {
      ...
      <div class="consciousness-overlay">
        ...
        <div class="hive-logo-center">
          <img src="${Hive_Logo_small_jpg_1.default}" alt="HiveTechs Logo" class="hive-logo-img" />
        </div>
    ...
    startIdleAnimation() {
        ...
        this.neurons.forEach((neuron, i) => {
            ...
            neuron.orbitAngle = (i / this.neurons.length) * Math.PI * 2;
            neuron.orbitRadius = 40 + Math.random() * 30;
            neuron.orbitSpeed = 0.001 + Math.random() * 0.002;
            neuron.baseX = this.centerCore.x;
            neuron.baseY = this.centerCore.y;
        });
    ...
    hide() {
        ...
        const logoCenter = this.container.querySelector('.hive-logo-center');
        if (logoCenter) {
            logoCenter.innerHTML = `<img src="${Hive_Logo_small_jpg_1.default}" alt="HiveTechs Logo" class="hive-logo-img" />`;
        }
        // Reset phase indicator to idle
        const statusElement = this.container.querySelector('.phase-status');
        if (statusElement)
            statusElement.textContent = 'Neural Core';
    ...
    showCompletion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.animateCompletionPhase();
        });
    }
    animateCompletionPhase() {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                const completionAnimation = () => {
                    ...
                    if (progress < 0.3) {
                        ...
                        for (let i = 0; i < 5; i++) {
                            ...
                            this.particles.push(new Particle(this.centerCore.x, this.centerCore.y, x, y, color));
                        }
                        // Flash the core
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (phase) {
                case 'memory':
                    ...
                    yield this.animateMemoryPhase();
                    break;
                case 'synthesis':
                    this.currentPhase.name = 'synthesis';
                    yield this.animateSynthesisPhase();
                    break;
                case 'classification':
                    this.currentPhase.name = 'classification';
                    yield this.animateClassificationPhase();
                    break;
                case 'generator':
                    this.currentPhase.name = 'generator';
                    yield this.animateGeneratorPhase();
                    break;
                case 'refiner':
                    this.currentPhase.name = 'refiner';
                    yield this.animateRefinerPhase();
                    break;
                case 'validator':
                    this.currentPhase.name = 'validator';
                    yield this.animateValidatorPhase();
                    break;
                case 'curator':
                    this.currentPhase.name = 'curator';
                    yield this.animateCuratorPhase();
                    break;
            }
        });
    }
    updateLogoCenter(phase) {
        const logoCenter = this.container.querySelector('.hive-logo-center');
        if (!logoCenter)
            return;
        const stageIcons = {
            ...
            return new Promise(resolve => {
                ...
                const classificationAnimation = () => {
                    ...
                    if (progress < 0.5 && Math.random() < 0.2) {
                        ...
                        const x = this.centerCore.x + Math.cos(angle) * distance;
                        const y = this.centerCore.y + Math.sin(angle) * distance;
                        this.particles.push(new Particle(this.centerCore.x, this.centerCore.y, x, y, '#fbbf24'));
                    }
                    // Core energy surge
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise(resolve => {
                ...
                const validatorAnimation = () => {
                    ...
                    if (Math.random() < 0.3) {
                        this.particles.push(new Particle(this.centerCore.x, this.centerCore.y, scanX, scanY, '#00ff00'));
                    }
                    ...
                    if (progress > 0.3 && Math.random() < 0.1) {
                        ...
                        for (let i = 0; i < 8; i++) {
                            ...
                            this.particles.push(new Particle(this.centerCore.x, this.centerCore.y, x, y, '#00ff88'));
                        }
                    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise(resolve => {
                ...
                const curatorAnimation = () => {
                    ...
                    this.neurons.forEach(neuron => {
                        const distToCenter = Math.sqrt(Math.pow(neuron.x - this.centerCore.x, 2) +
    ...
    animate() {
        ...
        this.neurons.forEach(neuron => {
            ...
            if (n.stageColor) {
                neuron.currentColor = n.stageColor;
            }
            else {
                neuron.currentColor = '#64c8ff'; // Default blue
            }
...
exports.NeuralConsciousness = NeuralConsciousness;
...
class Neuron {
    ...
    draw(ctx) {
        ...
        const currentColor = this.currentColor || '#64c8ff';
        // Parse color for gradient
        const colorMap = {
            '#64c8ff': { r: 100, g: 200, b: 255 },
            '#a78bfa': { r: 167, g: 139, b: 250 },
            '#fbbf24': { r: 251, g: 191, b: 36 },
...
//# sourceMappingURL=neural-consciousness.js.map