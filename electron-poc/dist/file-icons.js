...
exports.createIconElement = exports.getFolderIcon = exports.getFileIcon = exports.folderIconMap = exports.fileNameMap = exports.fileIconMap = void 0;
...
function getFileIcon(fileName) {
    ...
    if (exports.fileNameMap[fileName]) {
        return exports.fileNameMap[fileName];
    }
    // Check file extension
    const ext = (_a = fileName.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    if (ext && exports.fileIconMap[ext]) {
        return exports.fileIconMap[ext];
    }
    // Default file icon
...
function getFolderIcon(folderName, isExpanded = false) {
    ...
    if (exports.folderIconMap[folderName]) {
        return exports.folderIconMap[folderName];
    }
    // Default folder icon
    return {
 ...
 */
function createIconElement(iconMapping) {
