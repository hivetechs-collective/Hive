...
impl GitIcons {
    ...
    pub fn sync_spin(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path d="M13.915 7.5a5.5 5.5 0 0 1-11 0 5.5 5.5 0 0 1 11 0zm-6.61 2.468A2.5 2.5 0 0 0 10.5 7.5h1a3.5 3.5 0 0 1-4.486 3.357l.291-.889zm1.516-4.936A2.5 2.5 0 0 0 5.5 7.5h-1a3.5 3.5 0 0 1 4.486-3.357l-.291.889z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path d="M13.915 7.5a5.5 5.5 0 0 1-11 0 5.5 5.5 0 0 1 11 0zm-6.61 2.468A2.5 2.5 0 0 0 10.5 7.5h1a3.5 3.5 0 0 1-4.486 3.357l.291-.889zm1.516-4.936A2.5 2.5 0 0 0 5.5 7.5h-1a3.5 3.5 0 0 1 4.486-3.357l-.291.889z"/></svg>"##,
        }
    }
    ...
    pub fn check(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.431 3.323l-8.47 10-.79-.036-3.35-4.77.818-.574 2.978 4.24 8.051-9.506.764.646z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.431 3.323l-8.47 10-.79-.036-3.35-4.77.818-.574 2.978 4.24 8.051-9.506.764.646z"/></svg>"##,
        }
    }
    ...
    pub fn x(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 8.707l3.646 3.647.708-.707L8.707 8l3.647-3.646-.707-.708L8 7.293 4.354 3.646l-.707.708L7.293 8l-3.646 3.646.707.708L8 8.707z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 8.707l3.646 3.647.708-.707L8.707 8l3.647-3.646-.707-.708L8 7.293 4.354 3.646l-.707.708L7.293 8l-3.646 3.646.707.708L8 8.707z"/></svg>"##,
        }
    }
    ...
    pub fn warning(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.56 1h.88l6.54 12.26-.44.74H1.44L1 13.26 7.56 1zM8 2.28L2.28 13H13.7L8 2.28zM8.625 12v-1h-1.25v1h1.25zm-1.25-2V6h1.25v4h-1.25z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.56 1h.88l6.54 12.26-.44.74H1.44L1 13.26 7.56 1zM8 2.28L2.28 13H13.7L8 2.28zM8.625 12v-1h-1.25v1h1.25zm-1.25-2V6h1.25v4h-1.25z"/></svg>"##,
        }
    }
    ...
    pub fn plus(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path d="M14 7v1H8v6H7V8H1V7h6V1h1v6h6z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path d="M14 7v1H8v6H7V8H1V7h6V1h1v6h6z"/></svg>"##,
        }
    }
    ...
    pub fn minus(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path d="M14 8v1H2V8h12z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path d="M14 8v1H2V8h12z"/></svg>"##,
        }
    }
    ...
    pub fn history(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.507 13.532a8 8 0 1 0 0-11.064l-.71.71a7 7 0 1 1 0 9.644l.71.71zM7.5 3v5.5l3.5 2.1.6-1L8.5 7.8V3h-1z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.507 13.532a8 8 0 1 0 0-11.064l-.71.71a7 7 0 1 1 0 9.644l.71.71zM7.5 3v5.5l3.5 2.1.6-1L8.5 7.8V3h-1z"/></svg>"##,
        }
    }
    ...
    pub fn commit(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path d="M11.748 8a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path d="M11.748 8a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0z"/></svg>"##,
        }
    }
    ...
    pub fn remote(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.904 9.57L8.928 5.596l3.976-3.976-.619-.62L8 5.286v.619l4.285 4.285.62-.619zM3 5.62l4.285 4.285.62-.619L3.928 5.31 7.904 1.334 7.285.715 3 5v.619z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.904 9.57L8.928 5.596l3.976-3.976-.619-.62L8 5.286v.619l4.285 4.285.62-.619zM3 5.62l4.285 4.285.62-.619L3.928 5.31 7.904 1.334 7.285.715 3 5v.619z"/></svg>"##,
        }
    }
    ...
    pub fn stash(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path d="M10 2v2H6V2h4zm1 0h2.5a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H5v2a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V2zm0 4H5v1h6V6zm0 2H5v1h6V8zm-6 2h6v1H5v-1z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path d="M10 2v2H6V2h4zm1 0h2.5a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H5v2a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V2zm0 4H5v1h6V6zm0 2H5v1h6V8zm-6 2h6v1H5v-1z"/></svg>"##,
        }
    }
    ...
    pub fn diff(theme: &Theme) -> &'static str {
        match theme {
            Theme::Dark => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#cccccc"><path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.5l.5-.5h5l.5.5v9l-.5.5h-5l-.5-.5v-9zM3 12h4V6H3v6zm0-7h4V4H3v1zm6.5-2h5l.5.5v9l-.5.5h-5l-.5-.5v-9l.5-.5zm.5 9h4v-2h-4v2zm0-3h4V4h-4v5z"/></svg>"##,
            Theme::Light => r##"<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#424242"><path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.5l.5-.5h5l.5.5v9l-.5.5h-5l-.5-.5v-9zM3 12h4V6H3v6zm0-7h4V4H3v1zm6.5-2h5l.5.5v9l-.5.5h-5l-.5-.5v-9l.5-.5zm.5 9h4v-2h-4v2zm0-3h4V4h-4v5z"/></svg>"##,
        }
    }
