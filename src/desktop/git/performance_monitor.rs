...
use super::performance_config_ui::{PerformanceConfigUI, PerformanceConfigProps};
...
#[component]
pub fn PerformanceGraph(
    history: Vec<(Instant, PerformanceStats)>,
    height: Option<u32>,
) -> Element {
