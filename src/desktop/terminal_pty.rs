...
use portable_pty::{CommandBuilder, NativePtySystem, PtySystem, PtySize, MasterPty};
use std::sync::Arc;
...
impl PtyProcess {
    ...
    pub fn spawn(command: &str, args: &[&str], working_dir: &str) -> Result<(Self, mpsc::Receiver<String>)> {
