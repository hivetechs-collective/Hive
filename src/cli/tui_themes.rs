...
impl ThemeManager {
    ...
    fn light_theme() -> TuiTheme {
        TuiTheme {
            ...
            colors: ThemeColors {
                ...
                progress_active: ThemeColor::Rgb {
                    r: 255,
                    g: 140,
                    b: 0,
                },
                ...
                consensus_progress: ThemeColor::Rgb {
                    r: 255,
                    g: 140,
                    b: 0,
                },
                ...
                syntax_function: ThemeColor::Rgb {
                    r: 255,
                    g: 140,
                    b: 0,
                },
    ...
    fn solarized_theme() -> TuiTheme {
        TuiTheme {
            ...
            colors: ThemeColors {
                ...
                validator: ThemeColor::Rgb {
                    r: 133,
                    g: 153,
                    b: 0,
                }, // green
                curator: ThemeColor::Rgb {
                    r: 211,
                    g: 54,
                    b: 130,
                }, // magenta
                ...
                progress_complete: ThemeColor::Rgb {
                    r: 133,
                    g: 153,
                    b: 0,
                },
                progress_waiting: ThemeColor::Rgb {
                    r: 88,
                    g: 110,
                    b: 117,
                },
                progress_error: ThemeColor::Rgb {
                    r: 220,
                    g: 50,
                    b: 47,
                },

                user_input: ThemeColor::Rgb {
                    r: 133,
                    g: 153,
                    b: 0,
                },
                system_response: ThemeColor::Rgb {
                    r: 131,
                    g: 148,
                    b: 150,
                },
                ...
                help_text: ThemeColor::Rgb {
                    r: 38,
                    g: 139,
                    b: 210,
                },
                status_text: ThemeColor::Rgb {
                    r: 88,
                    g: 110,
                    b: 117,
                },

                syntax_keyword: ThemeColor::Rgb {
                    r: 211,
                    g: 54,
                    b: 130,
                },
                syntax_string: ThemeColor::Rgb {
                    r: 42,
                    g: 161,
                    b: 152,
                },
                syntax_comment: ThemeColor::Rgb {
                    r: 88,
                    g: 110,
                    b: 117,
                },
                syntax_number: ThemeColor::Rgb {
                    r: 220,
                    g: 50,
                    b: 47,
                },
    ...
    fn default_styles() -> ThemeStyles {
        ThemeStyles {
            ...
            status_line: TextStyle {
                bold: false,
                italic: false,
                underlined: false,
                strikethrough: false,
            },
            progress_bar: TextStyle {
                bold: false,
                italic: false,
                underlined: false,
                strikethrough: false,
