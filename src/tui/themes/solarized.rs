...
pub fn create_solarized_theme() -> Theme {
    ...
    let styles = StyleDefinitions {
        ...
        status_bar: Style::default().bg(solarized.blue).fg(solarized.base03),

        panel: Style::default().bg(solarized.base03).fg(solarized.base0),

        active_border: Style::default()
            .fg(solarized.blue)
            .add_modifier(Modifier::BOLD),

        inactive_border: Style::default().fg(solarized.base01),
        ...
        tab: Style::default().bg(solarized.base02).fg(solarized.base01),
        ...
        editor: Style::default().bg(solarized.base03).fg(solarized.base0),

        terminal: Style::default().bg(solarized.base03).fg(solarized.base0),

        terminal_output: Style::default().fg(solarized.base0),
        ...
        input_inactive: Style::default().bg(solarized.base02).fg(solarized.base01),

        text: Style::default().fg(solarized.base0),
    };
