...
impl<'a> HelpPopup<'a> {
    ...
    fn keyboard_shortcuts_content(&self) -> Vec<Line> {
        vec![
            Line::from(vec![
                Span::styled("Navigation:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Panel Focus (VS Code style):", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Quick Commands:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Other:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
    ...
    fn commands_content(&self) -> Vec<Line> {
        vec![
            Line::from(vec![
                Span::styled("Core Commands:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("System Commands:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Examples:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            Line::from(vec![
                Span::raw("ask "),
                Span::styled("\"What is the best way to structure this Rust project?\"", self.theme.secondary_style()),
            ]),
            Line::from(vec![
                Span::raw("analyze "),
            ...
            Line::from(vec![
                Span::raw("plan "),
                Span::styled("\"Add user authentication with JWT tokens\"", self.theme.secondary_style()),
            ]),
        ]
    }
    ...
    fn about_content(&self) -> Vec<Line> {
        vec![
            Line::from(vec![
                Span::styled("HiveTechs Consensus", self.theme.primary_style().add_modifier(Modifier::BOLD)),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Features:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
            ...
            Line::from(""),
            Line::from(vec![
                Span::styled("Technology:", self.theme.accent_style().add_modifier(Modifier::BOLD)),
            ]),
