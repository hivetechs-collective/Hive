            ...
            executor: Arc::new(StreamingOperationExecutor::new(
                Arc::new(crate::consensus::FileOperationExecutor::new(
                    ...
                    crate::consensus::operation_intelligence::OperationIntelligenceCoordinator::new(
                        Arc::new(crate::consensus::KnowledgeIndexer::new().await.unwrap()),
                        Arc::new(crate::consensus::ContextRetriever::new().await.unwrap()),
                        Arc::new(crate::consensus::PatternRecognizer::new().await.unwrap()),
                        Arc::new(crate::consensus::QualityAnalyzer::new().await.unwrap()),
                        Arc::new(crate::consensus::KnowledgeSynthesizer::new().await.unwrap()),
                    ),
                )),
